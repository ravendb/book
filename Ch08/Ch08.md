...
![A cluster with members and watchers](./Ch8/img01.png)
...
![Several external replication tasks and their responsible nodes](./Ch8/img02.png)
...
![Database topology graph for a database in partial failure mode](./Ch8/img03.png)
...
![Database topology when the supervisor adds another node to a database group on the fly.](./Ch8/img04.png)
...
![Database topology with two healthy replicas and a failed node B that will soon be deleted.](./Ch8/img05.png)
