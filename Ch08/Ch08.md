...
characters and saving. RavenDB will attempt to send the update over but fail, and you'll get the error shown in Figure 8.12.

![Adding additional tables to the SQL ETL process](./Ch08/img12.png)
