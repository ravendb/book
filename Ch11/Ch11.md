...
![A MapReduce index aggregation `Orders` by `Company`](./Ch11/img02.png)
...
```{caption="Output of the query in Listing 11.8, showing enriched result set of MapReduce index" .js}
{
