...
Artificial documents are updated whenever the index completes a batch of documents, so there is very little
lag time between the index picking up changes and the artificial documents update. If this was the only
