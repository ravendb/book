...
> `reduce` function, it is going to fail in a similar manner. This is common when you have calls to `First` or use
> arrays in the MapReduce index. If you care about the order of operations, you'll need to ensure that as part of
