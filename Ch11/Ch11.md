...
whose output is a computed field ("Name"), which in turn is the result of a concatenation of two values from the document. In Listing 11.5, you can see that we're querying
...
trivial. What makes it interesting is that this allows us to run a query such as the one in Listing 11.7.
