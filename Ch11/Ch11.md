...
## Map-Reduce and Aggregations in RavenDB

[Map Reduce]:(#map-reduce)

Map-reduce is an old term. It came from Lisp and was used as early as the 1960s. For a long time, it was primarily known only by
functional language afficandos, and it was rarely seen outside their circles. In 2004, the Google paper
