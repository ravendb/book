...
In particular, searching employees by a manager's name leads to confusion about which manager you are talking about if your manager
have common names. Even so, sometimes this is something that you just have to do. The users may require it to behave in this manner 
...
```{caption="Using RQL to update the manager's name in all the managed employees"}
from Employees as e
...
The only thing that is of interest in Listing 10.27 
