...
Another use case for Multi Map/Reduce is to treat the documents from the same collection differently. For example, let us say that we want to know the value of the products 
