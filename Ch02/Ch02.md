...
Usually I actually got to use my NHibernate knowledge to optimize the way the system accessed the database. But that usually happened at least several days into my visit. The first few days _always_ consisted of finding the common Select N+1 issues, finding the common Unbounded Result Set issues, etc.
