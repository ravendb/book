...
In the real world, I've seen such things happen with payroll systems and paystubs. An employee got married, and changed her bank account information to the new shared bank account. The couple also wanted to purchase a home, so they applied for a mortgage. As part of that, they had to submit paystubs from the past several months. 
