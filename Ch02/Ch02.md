...
Create a new console application and run the command in Listing 2.1 on the console.
...
human-readable document identifier and to force uniqueness of a certain value (the uniqueness of the email address). While 
...
When the test reads this line, a magical thing will happen, as shown in Figure 2.14. The studio will open, and you'll be able to
...
![Peeking into running test instance, mid test](./Ch02/img14.png)

At this time, the rest of the test is suspended, waiting for you to confirm you're done peeking inside. You can do that 
by clicking the button shown in Figure 2.15, after which your test will resume normally and (hopefully) turn green.

![Press this to continue the test](./Ch02/img15.png)
