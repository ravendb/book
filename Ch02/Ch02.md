...
Taken together, this means that ever since 2004, my job was largely to go to clients and try to get their applications to perform well, be stable and scale to their requirements. The problem with that was that at some point, I made a mistake. I was doing a code review for two clients, and I sent each of them the report about the issues found in the _other client's code_ and how to resolve it.
