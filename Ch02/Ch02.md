...
this chapter. Those were `people/1-A`, `ToDoTasks/4-A` and the like. 
...
see in Figure 2.11. But trying to include the raw Emoji in the book broke the build for this book.
