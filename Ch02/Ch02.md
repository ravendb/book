...
and the optimization opportunities that they provide are discussed at length in [Chapter 26](#stroage-layout). 
...
A much deeper discussion of authentication, managing API Keys and security in general can be found in [Chapter 20](#security).
