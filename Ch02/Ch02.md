...
Graph databases allow you to define nodes and associate them using edges, and then allow queries to traverse them as needed. Some databases also offer some graph algorithms (shortest path, djikstra, etc), but a lot of them function mostly as a queryable adjacency list.
