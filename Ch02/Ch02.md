...
but the details on the state of a newly minted node are a bit complex and covered in more detail in the
...
to inspect, validate and modify the content of the in-memory database (while the test is _still running_).
