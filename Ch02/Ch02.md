...
Since then, I've become quite fond of ravens; many of the internal components inside RavenDB are now named after various ravens. At around the same time that I decided on the name change, I also realized that just doing this as an open source project isn't going to be enough for me.
