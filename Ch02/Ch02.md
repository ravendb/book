...
mean for working with the data? Let's say that, given a task ID, we want to print the details of the corresponding task, including the name of the person assigned to it. Listing 2.15 shows the obvious way to do this.
