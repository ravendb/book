...
authentication, and typically API keys are granted on a per application / role basis.
...
> the database. It's common to see an application making tens of calls to the database to service a single request, usually
> for no good reason.  
