...
The most obvious way to get an identifier is to ask the user to generate it. This is typically when the identifier is some sort
of meaningful value. For example, `people/oscar@arava.example` or `accounts/591-192` are two document ids 
