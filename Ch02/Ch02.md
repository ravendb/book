...
you looked at the database state, you can resume the test and continue execution.
...
the server). RavenDB makes use of metadata to hold critical information such as the document collection, when it was last modifed, etc. 
