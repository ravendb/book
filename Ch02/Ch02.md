...
Start by adding the code in Listing 2.1 to the `Patch script` text box.
...
The code samples in this book use C#, but the documentation can guide you on how to achieve the same results in any
supported clients. 
