...
with multi-thread solutions is the notion of an atomic compare-and-swap operation. From code, this will be
...
We'll talk more about compare exchange values in Chapter 6. For now, it is good to remember that they are there and can help
