...
Invoke-WebRequest -Uri "https://uploads.github.com/repos/ayende/book/releases/$id/assets?name=Inside RavenDB 4.0.pdf" `
	-Headers @{"Authorization" = "token $token"; "Accept" = "application/vnd.github.v3+json"} `
...
Invoke-WebRequest -Uri "https://uploads.github.com/repos/ayende/book/releases/$id/assets?name=Inside RavenDB 4.0.epub" `
	-Headers @{"Authorization" = "token $token"; "Accept" = "application/vnd.github.v3+json"} `
...
Invoke-WebRequest -Uri "https://uploads.github.com/repos/ayende/book/releases/$id/assets?name=Inside RavenDB 4.0.mobi" `
	-Headers @{"Authorization" = "token $token"; "Accept" = "application/vnd.github.v3+json"} `
