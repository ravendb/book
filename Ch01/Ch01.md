...
This book is effectively a book-length blog post. The main idea here is that I want to give you a way to _grok_^[Grok means to understand so thoroughly that the observer becomes a part of the observed—to merge, blend, intermarry, lose identity in group experience.  Robert A. Heinlein, Stranger in a Strange Land] RavenDB. This means not only gaining knowledge of what it does, but how it does it and all the reasoning behind the bytes. In effect, I want you to understand all the _whys_ of RavenDB.
