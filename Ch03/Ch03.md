...
In order to handle this scenario from an end to end perspective, we need to send to the client the etag of the document as well as the actual document itself. And when we request an update to the document, we'll need to specify the 
