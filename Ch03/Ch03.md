...
this order. This make it an explicit action in your domain, instead of just tacking it onto the existing objects.
...
We looked at handling binary data with attachments, auditing and change tracking using the revisions feature and learned that we can expire documents natively
