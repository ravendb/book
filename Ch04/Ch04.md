...
from the server. We already gone over `Include` in [Chapter 2](#zero-to-ravendb) and in this one we looked at lazy requests, allowing us to combine 
...
we'll do so extensively when we get to [Chapter 9](#map-indexes) and beyond and discuss indexing.
