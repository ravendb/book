...
that we'll get them all in the list. But what will happen if this customer has 30,000 calls? Image 4.1 shows how a query is processed on the server in this 
case. 
...
queries are a bad idea. RavenDB also supports the notion of _streaming_ queries. You can see how that would look like in Image 4.2.
