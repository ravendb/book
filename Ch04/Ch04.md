...
This is the sharp end of the stick, and abusing this feature can cause problems. In particular, the scripts are run under a lock, and can slow or prevent the database from completing transactions quickly. 
