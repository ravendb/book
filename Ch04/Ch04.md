...
when we discuss MapReduce indexes, in the ["MapReduce"](#map-reduce) chapter] but this is a pretty complex solution, and it isn't relevant when you have different 
...
we'll do so extensively when we get to ["MapReduce"](#map-reduce) and, beyond that, when we discuss indexing.
