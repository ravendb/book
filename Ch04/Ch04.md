...
session will figure out what documents have changed and will send them to the server. This model is simple and easy to follow, and it's the recommended way to work.
...
to know? We already know how to load a document, and how to query them. We covered that in [Zero to RavenDB](#zero-to-ravendb). We also covered `Include` and how
...
when we'll discuss map/reduce indexes, in the [Map/Reduce](#map-reduce) chapter], but this is a pretty complex solution, and isn't relevant when you have different 
