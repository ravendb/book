...
partial modification of the document. If you'll use patching to update the document (discussed in <<ravnedb-client-api>>), you might get this behavior.
...
We'll discuss listeners and their use in more depth in <<ravnedb-client-api>>.
...
We'll see how to use the expiration feature in <<ravnedb-client-api>>. There isn't much to say about it besides that
