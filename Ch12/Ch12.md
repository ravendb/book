...
> new index definition. In the locked mode, a new index definition would return successfully but would not actually 
...
the admin better accountability and control. In the studio, you can go to `Managed Server` and then click `Advanced` and 
