...
that you'll bring back structure to such a system. An index will take the documents as input and then output the index entries in a 
...
We also have another inner class called `Result`. (Again, using an inner class is a mere convention because it keeps the `Result`
