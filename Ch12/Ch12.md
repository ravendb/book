...
```{caption="Parsing UK `PostalCode` as `int` _will_ throw an exception" .cs}
...
going to fail. Let's see how RavenDB behaves in such a case. Figure 12.10 shows how this looks in the 
studio.
...
This chapter has marked the end of theory and high-level discussion and a move toward a more
