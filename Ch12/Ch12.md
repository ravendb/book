...
> 
> In the locked mode, a new index definition would return successfully but would not actually 
...
> may not be in the same cluster. This is often used as a separate hot spare, offsite backup, etc. It's important that
