...
The timeline view in Figure 12.8 shows several indexes and the running at once. (Solid colors mean the index batch is 
...
not using streaming. (Streaming queries were discussed in [Chapter 4](#advanced-client-api).) This can lead
