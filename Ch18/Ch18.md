...
Figure 18.1 shows the new node screen. There isn't much there, because you don't need to do much beyond providing the URL
...
In Figure 18.2, you can see the nodes in the cluster view in the Studio. The red trash icon at the top right allows you to remove the node
