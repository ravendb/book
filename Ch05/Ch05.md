...
see the task selection dialog shown in Figure 5.1. Ignore the rest of the tasks and select `Subscription`. You'll the subscription edit form, now name the task "CustomersSubscription" and select the `Customers` collection. This is it, you can save the subscription. The result of this is shown in Figure 5.2.
