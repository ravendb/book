...
> **Benchmark & lies**
>
> A note about the performance numbers. I'm not trying to do a benchmark here for aboslutely the best performance. I'm actually running this with a debug build of RavenDB on both the client & server, while the system is also running integration tests in the background. 
> What I'm trying to do is to give you a sense of the relative performance differences between the session and bulk insert.
