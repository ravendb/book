...
Counter values in RavenDB range from `−9,223,372,036,854,775,808` through `9,223,372,036,854,775,807`. Attempts to 
increase the value over the maximum or below the minimum will *not* overflow. An error will be raised in this case.

> **Distributed overflow detection**
>
> TODO: Discuss this when the behavior is settled.
...
to _do_ with counters. Each counter represent a 64 bits number, which can range between  
...
value, we need to actually index the counter value.
