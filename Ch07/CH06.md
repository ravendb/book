...
![A simple database on a single node](./Ch7/img01.png)
...
![The node tag in two nodes](./Ch7/img02.png)
...
![A single node cluster in the management screen](./Ch7/img03.png)
...
![Our cluster after adding the second node](./Ch7/img04.png)
...
![New leader selected after recovery of failed node](./Ch7/img05.png)
...
![A five nodes cluster](./Ch7/img06.png)
...
![An easy way to know which node you're on is to look at the tab icon](./Ch7/img07.png)
...
![The Spade database as seen from node `D`](./Ch7/img08.png)
...
![The Spade and Pitchfork databases in our RavenDB cluster](./Ch7/img09.png)

Figure 7.9 shows the databases from the Studio in node `D`. So we have Pitchfork on three nodes and Spade on two. You can go ahead and
...
![A cluster hosting a whole garden shed of databases](./Ch7/img10.png)

In Figure 7.10, you can see that we created eight databases and that they're all spread out throughout the cluster. This means
...
![Configuring client read balancing behavior from the server side](./Ch7/img11.png)
...
![A database group with three  nodes, one of which is down](./Ch7/img12.png)
...
![A document change vector in a cluster](./Ch7/img13.png)
...
![Configuring server side conflict resolution policy in the Studio](./Ch7/img14.png)
...
![First version of `users/1` document after modifications on node `B`](./Ch7/img15.png)

![Second version of `users/1` document after modifications on node `A`](./Ch7/img16.png)
...
In fact, you'll see _two_ versions of this document, as displayed in Figure 7.17. For developers, the screen shown may look very familiar. It's
...
![Manual conflict resolution in the Studio](./Ch7/img17.png)
...
Listing 7.9 shows how an engineer can register to the pool of available engineers.
...
![The available engineers compare exchange value in the Studio](./Ch7/img18.png)
