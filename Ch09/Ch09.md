...
### The Raven Query Language

Requiring that all queries will always use an index has a few interesting results. It means that queries tend to be _really_ fast, because
