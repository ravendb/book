...
![Defining a connection string to another RavenDB instance.](./Ch9/img01.png)
...
![Defining an ETL process to another RavenDB instance](./Ch9/img02.png)
...
![Defining a simple "copy the whole collection" ETL script](./Ch9/img03.png)
...
![Using ETL with a script to redact the results](./Ch9/img04.png)
...
> 
> ![Resetting the ETL process after a script update](./Ch9/img05.png)
...
![Multiple outputs from a single source document on the destination](./Ch9/img06.png)
...
![Data flow diagram for a POS system with replication and ETL processes.](./Ch9/img07.png)
...
![Creating a new SQL connection string](./Ch9/img08.png)
...
![Specifying a table to be used in the ETL process](./Ch9/img09.png)
...
![Result of SQL ETL script on the relational database side](./Ch9/img10.png)
...
![Adding additional tables to the SQL ETL process](./Ch9/img11.png)
...
![Showing SQL ETL errors in the Studio](./Ch9/img12.png)
