...
like the streaming feature, which we covered in the Chapter 4. However, subscriptions are _meant_ for batch processing. Instead of just getting all 
...
You can create the subscription through the RavenDB Studio. In the same database that we used in the Chapter 4, go to `Settings` and then `Manage Ongoing Tasks`, and you'll 
...
![Database tasks selection dialog](./Ch06/img01.png)

![The newly created customers subscription](./Ch06/img02.png)
...
![Testing the customers subscription](./Ch06/img03.png)
...
![This subscription filters support calls on the server side](./Ch06/img04.png)
...
> change vector, as we discussed in the Chapter 4. However, reading from one node and writing to another can lead to subtle concurrency issues. 
