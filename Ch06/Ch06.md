...
Let us look at Listing 1, this is the external respresentation of the index, but internally, we add a few things that we need to the defintion, so it ends up looking like this:
