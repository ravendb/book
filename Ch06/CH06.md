...
### Architectural consideration in cluster setup
...
need to consider. A single large cluster is usually easier to manage and the cluster 



In order to avoid that, RavenDB allows 

#### Sharing data between database groups
...
### When the clsuter is unavailable?