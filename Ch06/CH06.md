...
a support call. The code to complete this task is show in Listing 6.10. 
...
The whole idea with compare exchange values is that they give you atomic operation primitive in the cluster. So any typical
